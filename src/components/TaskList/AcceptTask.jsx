  ...
  return (
    <div className="bg-yellow-400 rounded-2xl shrink-0 h-full w-[25vw] p-5">
      ...
      <div className="flex justify-between items-center mt-4 px-1">
        <button className="bg-green-500 px-2 py-2 cursor-pointer active:scale-90 rounded-xl">
          Mark As Completed
        </button>
        <button className="bg-red-500 px-2 py-2 cursor-pointer active:scale-90 rounded-xl">
          Mark As Failed
        </button>
      </div>
    </div>
